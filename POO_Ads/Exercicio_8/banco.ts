class Conta {
    ...
    constructor(id: number, numero: string, saldo: number) {
        this.validaValor(saldo); // Valida o saldo inicial
        this._id = id;
        this._numero = numero;
        this._saldo = saldo;
    }
    ...
    public sacar(valor: number): void {
        this.validaValor(valor); // Valida o valor do saque
    ...
    public depositar(valor: number): void {
        this.validaValor(valor); // Valida o valor do depósito
        this._saldo = this._saldo + valor;
    }

    public transferir(contaDestino: Conta, valor: number): void {
        this.sacar(valor); // Já valida o valor do saque
        contaDestino.depositar(valor); // Já valida o valor do depósito
    }
